...
var App = /*#__PURE__*/function () {
  ...
  _createClass(App, [{
    ...
    value: function toUpperCaseFirst(val) {
      return val.charAt(0).toUpperCase() + val.slice(1);
    }
  }, {
    key: "handleKeydown",
    value: function handleKeydown(e, trigger) {
      this.currentTarget(e).trigger(trigger);
      this.currentTarget(e).focus();
    }
  }, {
    key: "onKeydownEnter",
    value: function onKeydownEnter(sel, cb) {
      var _this = this;
      var trigger = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'click';
      this.el.on('keydown', "".concat(sel), function (e) {
        if (_this.isEnter(e)) {
          cb ? cb(e) : _this.handleKeydown(e, trigger);
        }
      }.bind(this));
    }
  }, {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 8:
                ...
                _context.next = 11;
                return Rest.get('/js/site-search-data.json');
              case 11:
                res = _context.sent;
                if (!res.ok) {
                  _context.next = 17;
                ...
                return res.json();
              case 15:
                window.apps.searchData = _context.sent;
    ...
    key: "applyStyles",
    value: function applyStyles(args) {
    ...
    value: function applyTheme() {
      ...
      for (var section in window.apps.theme) {
        if (path.includes(section)) {
          var $page = $('.c-documentation');
          if (window.apps.theme[section].cssModifier) {
            $page.addClass("c-documentation--".concat(window.apps.theme[section].cssModifier));
          }
...
var Breadcrumbs = /*#__PURE__*/function (_App) {
  _inherits(Breadcrumbs, _App);
  var _super = _createSuper(Breadcrumbs);
  function Breadcrumbs(el, args) {
    var _this2;
    _classCallCheck(this, Breadcrumbs);
    _this2 = _super.call(this, el, args);
    _this2.$ = {
    ...
    value: function build() {
      ...
      for (var i = 0; i < parts.length; i++) {
        ...
        if (name.length) {
          ...
          list += "<li class=\"".concat(i === parts.length - 1 ? this.classNames.active : '', "\"><a href=\"").concat(href, "\">").concat(this.toUpperCaseFirst(name), "</a></li>");
        }
      }
      this.$.list.html("<ul>".concat(list, "</ul>"));
    }
  }]);
  return Breadcrumbs;
}(App);
...
var Rest = /*#__PURE__*/function () {
  ...
  _createClass(Rest, null, [{
    ...
    key: "put",
    value: function put(url, data, type) {
      return Rest.send(url, 'PUT', data, type);
    }
  }, {
    key: "post",
    value: function post(url, data, type) {
      return Rest.send(url, 'POST', data, type);
    }
  }, {
    key: "delete",
    value: function _delete(url, type) {
  ...
  _createClass(Search, [{
    ...
    value: function events() {
      ...
      this.$.btn.on('click', function (e) {
        e.preventDefault();
        _this7.clearResults();
        if (_this7.$.io.val().length && !_this7.$.io.hasClass('is-hidden')) {
          _this7.searchSite(_this7.$.io.val());
        } else {
          _this7.$.io.val('');
          _this7.$.io.toggleClass('is-hidden');
          if (!_this7.$.io.hasClass('is-hidden')) {
            _this7.$.io.focus();
          }
        }
      }.bind(this));
...
var Sidebar = /*#__PURE__*/function (_App6) {
  ...
  _createClass(Sidebar, [{
    ...
    value: function buildTableOfContents() {
      ...
      var stack = [root];
      var traverse = function traverse(node, el, idx) {
