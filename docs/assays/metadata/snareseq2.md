...
These metadata fields have been collected for SNARE-seq2 data.<br />
These fields are available from the [HuBMAP Search and Entity APIs](/apis) at ```Dataset.metadata.<attribute>```.<br />
See the latest version of the [SNARE-seq2 Ingest Metadata Specifications](https://hubmapconsortium.github.io/ingest-validation-tools/snareseq2/current/) for the schema and directory structure needed when uploading data.
&nbsp;
