...
subjects: 
summary: A probe-based spatial transcriptomics approach that combines histological imaging with targeted transcriptomic profiling in the spatial context of intact tissue. Target-specific hybridization probes capture RNA sequences of interest from the tissue; the CytAssist instrument then transfers the probe-captured RNA to the spatially barcoded Visium slide for downstream sequencing. <p class="multiAssay"><span class="requiredMark">*</span> This reporting standard requires the inclusion of RNAseq (with probes) and Histology dataset metadata for completeness."</p> <p class="multiAssay"><span class="requiredMark">*</span> This reporting standard requires the inclusion of <a href="https://dx.doi.org/10.35079/HBM674.XVGG.736">RNAseq (with probes)</a> and <a href="https://dx.doi.org/10.35079/HBM678.SJXK.375">Histology</a> dataset metadata for completeness.</p>
schema_doc_href: "https://openview.metadatacenter.org/templates/https:%2F%2Frepo.metadatacenter.org%2Ftemplates%2F4646ec9d-f3c9-4619-bc45-7e14748bb976"
