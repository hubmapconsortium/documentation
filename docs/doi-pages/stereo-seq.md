...
title: Metadata Reporting Standards - Stereo-seq
spec_name: Spatial Enhanced Resolution Omics Sequencing (Stereo-seq)
version_label: Version 1
doi: 10.35079/HBM577.XHHB.694
download_href: "https://github.com/hubmapconsortium/ingest-validation-tools/raw/refs/heads/main/docs/stereo-seq/current/doi-object.zip"
md5_hash: 5f39ed6fff95b011c24dc613e75bcf14
...
|-
  ...
  | raw/stereo_seq/ |  | All relevant raw files for Stereo_seq. |
  | lab_processed/ | ✓ | Experiment files that were processed by the lab generating the data. |
  | lab_processed/stereo_seq/ |  | All relevant experiment files for Stereo_seq. |
