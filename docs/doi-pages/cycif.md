...
title: Metadata Reporting Standards - Cyclic Immunofluorescence (CyCIF) 
spec_name: CyCIF
...
|-
  ...
  | raw/images/*.czi$ | ✓ | Raw image file in CZI format |
  | raw/images/*.vsi$ |  | Raw image file for labs who are not using a Zeiss instrument. |
