...
contributors_note: For questions about this standard, email <mailto:help@hubmapconsortium.org>. Alternatively, reach out to the individuals listed below, either via the email address listed in the table or via contact information provided on their ORCID profile page.
example_tree: |-
  .
  ├── metadata.tsv
  ├── extras/
