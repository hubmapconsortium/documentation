...
title: Metadata Reporting Standards - Suspension
spec_name: Sample Suspension
descriptive_version: 2.1
structural_version: 
doi: 10.35079/HBM437.GKTS.458
download_href: "https://github.com/hubmapconsortium/ingest-validation-tools/raw/refs/heads/main/docs/sample-suspension/current/doi-object.zip"
md5_hash: 73ab7ff0559410c7a51db7611c2d6b58
...
|-
  ...
  | Suspension entity type <span class="requiredMark">*</span> | <i class="fa-solid fa-circle-nodes" title="Allowable Value" aria-label="Allowable Value"></i> | The type of single-cell entity that is derived from the isolation protocol. Example: Nucleus + cell | ```Nucleus + cell``` ```Nucleus``` ```cDNA``` ```Cell``` |
  | Suspension entity count <span class="requiredMark">*</span> | <i class="fa-solid fa-hashtag" title="Numeric" aria-label="Numeric"></i> | The total number of cells or nuclei obtained following the processes of dissociation and enrichment. Example: 300000 |  |
  | Is suspension enriched? <span class="requiredMark">*</span> | <i class="fa-solid fa-circle-dot" title="Radio" aria-label="Radio"></i> | Indicates whether the cell or nuclei population was enriched prior to analysis. Example: Yes | ```Yes``` ```No``` |
  | Suspension enriched target | <i class="fa-solid fa-font" title="Textfield" aria-label="Textfield"></i> | The target of enrichment if the suspension was enriched. Example: CD8+ T cells |  |
