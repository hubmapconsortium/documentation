...
|-
  ...
  | Calibration kit lot number <span class="requiredMark">*</span> | <i class="fa-solid fa-font" title="Textfield" aria-label="Textfield"></i> | The manufacturer's lot number for the calibration bead kit used in the experiment. If no calibration bead kit was used or the lot number is unknown, this field may be left blank. Example: EQ18 |  |
