...
title: Metadata Reporting Standards - IMC 2D
spec_name: 2D Imaging Mass Cytometry (IMC)
version_label: Version 1
doi: 10.35079/HBM428.VFLB.998
download_href: "https://github.com/hubmapconsortium/ingest-validation-tools/raw/refs/heads/main/docs/imc-2d/current/doi-object.zip"
md5_hash: 45e73ba6fbcf5f84a134ad36ac17f172
...
|-
  ...
  | Total run time value <span class="requiredMark">*</span> | <i class="fa-solid fa-hashtag" title="Numeric" aria-label="Numeric"></i> | The total run time, which is the duration the instrument takes to fully complete all imaging rounds on the loaded slide. Example: 24 |  |
  | Total run time unit <span class="requiredMark">*</span> | <i class="fa-solid fa-circle-nodes" title="Allowable Value" aria-label="Allowable Value"></i> | The unit of measurement for the total run time value. Example: hour | ```hour``` ```minute``` |
  ...
  | Ablation frequency value <span class="requiredMark">*</span> | <i class="fa-solid fa-hashtag" title="Numeric" aria-label="Numeric"></i> | The frequency at which laser ablation is performed, typically measured in hertz (Hz). This value indicates how often the laser pulses during the ablation process. Example: 200 |  |
  | Ablation frequency unit <span class="requiredMark">*</span> | <i class="fa-solid fa-circle-nodes" title="Allowable Value" aria-label="Allowable Value"></i> | The unit of measurement for the ablation frequency value. If no input frequency, this field may be left blank. Example: Hz | ```Hz``` |
...
|-
  ...
  | extras/.hardware.json$ | ✓ | JSON file containing the machine parameters/settings. This is akin to the microscope_environment.json file that's used to describe the imaging equipment. |
