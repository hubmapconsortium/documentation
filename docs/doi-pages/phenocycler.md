...
|-
  ...
  | raw/images/phenocycler/<br />{CombineInputs.txt,FocusMap.tif,FocusTable.txt,Label.tif,<br />MarkerList.txt,OverviewBF.tif,SampleMask.tif}$ | ✓ | Required file from the temp directory generated by the PhenoCycler. |
  | raw/images/phenocycler/<br />{CoverslipMask.tif,FlowCellOverview.tif,OverviewFL.tif,SampleValMask.tif}$ |  | The optional files from the temp directory generated by the PhenoCycler. These depend on which version of the PhenoCycler software was being used. |
