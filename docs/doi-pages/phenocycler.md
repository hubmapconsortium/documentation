...
|-
  ...
  | raw/images/phenocycler/<br />{CombineInputs.txt,FocusMap.tif,FocusTable.txt,Label.tif,MarkerList.txt,OverviewBF.tif,SampleMask.tif}$ | ✓ | Required file from the temp directory generated by the PhenoCycler. |
