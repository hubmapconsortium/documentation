...
|-
  ...
  | atomical structure label | <i class="fa-solid fa-font" title="Textfield" aria-label="Textfield"></i> | The label for the overarching anatomical structure. If the anatomical structure is not applicable or not specified, this field may be left blank. Example: Kidney |  |
...
|-
  ...
  | extras/microscope_settings.json | | [QA/QC] A file generated by the micro-meta app that contains a description of the settings used to acquire the image data. Email HuBMAP Consortium Help Desk help@hubmapconsortium.org if help is required in generating this document. |
